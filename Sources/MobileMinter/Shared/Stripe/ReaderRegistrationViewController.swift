...
class ReaderRegistrationViewController: TableViewController, DiscoveryDelegate,
  CancelableViewController, CancelingViewController
{
  ...
  override func viewDidLoad() {
    ...
    let cancelButton = UIBarButtonItem(
      title: "Back", style: .plain, target: self, action: #selector(dismissAction))
  ...
  func formSubmit() {
    ...
    AppDelegate.apiClient?.registerReader(withCode: registrationCode, label: label) {
  ...
  func terminal(_ terminal: Terminal, didUpdateDiscoveredReaders readers: [Reader]) {
    ...
    Terminal.shared.connectInternetReader(reader, connectionConfig: nil) {
