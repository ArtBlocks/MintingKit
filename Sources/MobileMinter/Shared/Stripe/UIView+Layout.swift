...
extension UIView {
  ...
  public func anchorToSuperviewAnchors(withInsets insets: UIEdgeInsets = UIEdgeInsets.zero) -> (
    ...
    let trailing = superview.trailingAnchor.constraint(
      equalTo: trailingAnchor, constant: insets.right)
  ...
  public func anchor(to layoutGuide: UILayoutGuide, withInsets insets: UIEdgeInsets = .zero) {
    ...
    leadingAnchor.constraint(equalTo: layoutGuide.leadingAnchor, constant: insets.left).isActive =
      true
    trailingAnchor.constraint(equalTo: layoutGuide.trailingAnchor, constant: -insets.right).isActive =
      true
    bottomAnchor.constraint(equalTo: layoutGuide.bottomAnchor, constant: -insets.bottom).isActive =
      true
  }
  ...
  public func constrainInsideSuperview(withInsets insets: UIEdgeInsets = .zero) {
    ...
    topAnchor.constraint(greaterThanOrEqualTo: superview.topAnchor, constant: insets.top).isActive =
      true
    leadingAnchor.constraint(greaterThanOrEqualTo: superview.leadingAnchor, constant: insets.left)
      .isActive = true
    trailingAnchor.constraint(lessThanOrEqualTo: superview.trailingAnchor, constant: -insets.right)
      .isActive = true
    bottomAnchor.constraint(lessThanOrEqualTo: superview.bottomAnchor, constant: -insets.bottom)
      .isActive = true
